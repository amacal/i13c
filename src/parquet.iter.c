...
const char *const PARQUET_COMPRESSION_NAMES[PARQUET_COMPRESSION_SIZE] = {
...
const char *const PARQUET_CONVERTED_TYPE_NAMES[PARQUET_CONVERTED_TYPE_SIZE] = {
...
const char *const PARQUET_DATA_TYPE_NAMES[PARQUET_DATA_TYPE_SIZE] = {
...
const char *const PARQUET_ENCODING_NAMES[PARQUET_ENCODING_SIZE] = {
...
const char *const PARQUET_PAGE_TYPE_NAMES[PARQUET_PAGE_TYPE_SIZE] = {
...
const char *const PARQUET_REPETITION_TYPE_NAMES[PARQUET_REPETITION_TYPE_SIZE] = {
