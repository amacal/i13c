...
#define ERROR_MAX DOM_ERROR_BASE - ERROR_BLOCK_SIZE

static const char *ERROR_MAP[] = {
  [ERROR_INDEX(THRIFT_ERROR_BASE)] = THRIFT_ERROR_NAME,
  [ERROR_INDEX(MALLOC_ERROR_BASE)] = MALLOC_ERROR_NAME,
  [ERROR_INDEX(PARQUET_ERROR_BASE)] = PARQUET_ERROR_NAME,
  [ERROR_INDEX(DOM_ERROR_BASE)] = DOM_ERROR_NAME,
};
